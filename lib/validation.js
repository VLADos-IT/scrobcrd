...
function validateParams(query) {
	...
	const safeBg = (normalizedBg !== 'transparent' && !isValidHexBg) ? DEFAULT_BG : normalizedBg;	const safeMode = ['smart', 'obsession', 'top', 'recent', 'now', 'list'].includes(mode) ? mode : DEFAULT_MODE;
